...
namespace TestConsole // Used for testing the functionalities of the ClassLibraryKAB
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            OrderHead myorderHead = ClassLibraryKAB.SQL.ReadOrderHead(1003);

            Console.WriteLine($"The orderhead is: { myorderHead.OrderHeadID}, { myorderHead.CustomerID}, { myorderHead.Discount}, { myorderHead.OrderDate}, { myorderHead.OrderStatus}");
